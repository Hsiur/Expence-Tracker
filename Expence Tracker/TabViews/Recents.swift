...
struct Recents: View {
    ...
    // User Properties
    @AppStorage("userName") private var userName: String = "Ruslan"
                ...
                ScrollView(.vertical) {
                    LazyVStack(spacing: 10, pinnedViews: [.sectionHeaders]) {
                        Section {
                            ...
                            // Card View
                           CardView(income: 4324, expence: 4236)
    ...
    func HeaderView(_ size: CGSize) -> some View {
        ...
        .background {
            ...
            .visualEffect { content, geometryProxy in
                content
                    .opacity(headerDGOpacity(geometryProxy))
            }
    ...
    func headerDGOpacity(_ proxy: GeometryProxy) -> CGFloat {
